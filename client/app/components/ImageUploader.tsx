 ...
 *
 * What:
 * - Presents the upload UI and delegates all behavior to useImageUploader hook.
 *
 * Usage:
 * - Place <ImageUploader /> where you need an upload area.
 *
 * Notes:
 * - Clearing the image calls the hook's clearImage, which in turn sets the global
 *   store image URL to an empty string '' (type-safe).
 */
        ...
        <div className="w-full max-w-md p-4">
          ...
          {!imagePreviewUrl ? (
            ...
            >
              <div className="flex flex-col items-center justify-center space-y-3">
                ...
                <div className="space-y-1">
                  <h3 className="font-medium text-gray-900" id="upload-label">
                    {uploadSuccess ? 'Upload Successful!' : 'Upload Room Image'}
                  </h3>
                  <p className="text-sm text-gray-500">
                    {uploadSuccess ? 'Your room image is ready' : <><span className="font-semibold text-blue-600">Click to upload</span> or drag and drop</>}
                  </p>
            ...
            <div className="relative rounded-xl overflow-hidden shadow-md animate-fadeIn">
              {imagePreviewUrl && (
                // Next.js <Image> is fine with object URLs on client.
                <Image
                  src={imagePreviewUrl}
                  alt="Room preview"
                  width={400}
